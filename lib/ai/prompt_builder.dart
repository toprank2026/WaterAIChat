...
- اختر نوع البطاقة الأنسب لسؤال المستخدم:
  ...
  • station_list: عند السؤال عن عدد المحطات أو قائمتها أو "ما هي المحطات" أو التصفية حسب نهر/محافظة استعمل station_list. مرّر اسم النهر أو المحافظة فقط في summary_text عند التصفية؛ وإذا أراد كل المحطات فاترك summary_text فارغاً (لا تضع نص السؤال كاملاً).
